...
export default class PromotionModel {
    ...
    async getPromotionByCol(data) {
        return fetch(GOBALS.URL + '/promotion/getPromotionByCol', {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
    ...
    async insertPromotion(data) {
        return fetch(GOBALS.URL + '/promotion/insertPromotion', {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
    ...
    async updatePromotion(data) {
        return fetch(GOBALS.URL + '/promotion/updatePromotion', {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
    ...
    async deletePromotion(data) {
        return fetch(GOBALS.URL + '/promotion/deletePromotion', {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
