...
export default class BookingModel {
    ...
    async getBookingBy(data) {
        return fetch(GOBALS.URL + '/booking/getBookingBy', {
            method: 'POST',
            headers: {
    ...
    async getBookingByCode(data) {
        return fetch(GOBALS.URL + '/booking/getBookingByCode', {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
    ...
    async deleteBooking(data) {
        return fetch(GOBALS.URL + '/booking/deleteBooking', {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
