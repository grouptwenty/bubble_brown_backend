...
class OrderView extends Component {
    ...
    async componentDidMount() {
        ...
        if (code != undefined) {
            ...
            console.log("orderlist_old", orderlist_old.data);
                    ...
                    <Card style={{ backgroundColor: '#fff', borderColor: 'transparent', minHeight: '65vh', padding: '0', marginTop: '-6px' }}>
                        <CardBody className="vc" ref="iScroll" style={{ height: "480px", overflow: "auto", }}>
                            ...
                            {this.state.cart != undefined && this.state.cart != "" && this.props.match.params.code != undefined ?
                                ...
                                : ''}
                            {this.state.cart != undefined && this.state.cart != "" && this.props.match.params.code == undefined ? <Row style={{ paddingTop: '30px', fontSize: '14pt' }} ><Col lg="12"><Button style={{ color: '#fff', }} size="lg" block color="success" onClick={this.insertOrder.bind(this)}><label>สั่งอาหาร</label></Button></Col></Row> : ''}
                            {this.state.cart != undefined && this.state.cart != "" && this.props.match.params.code != undefined ? <Row style={{ paddingTop: '30px', fontSize: '14pt' }}><Col lg="12"><Button style={{ color: '#fff', }} size="lg" block color="success" onClick={this.updateOrder.bind(this)}><label>แก้ไขรายการอาหาร</label></Button></Col></Row> : ''}
