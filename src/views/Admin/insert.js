...
//     const max_code = await admin_model.getAdminMaxCode()
//     this.setState({
//       province_list: province_list.data
//     })
//     document.getElementById("admin_code").value = 'A' + max_code.data.admin_code_max;
//   }
...
//     if (data_user_zipcode != undefined)
...
//       var res = await admin_model.insertAdminBy(arr);
...
//                                 {imagePreview}
//                               </Col>
//                               <input type="file" class="form-control" multiple onChange={this.onChangeHandler} id="admin_img"/>
//                             </div>
//                           </FormGroup>
//                         </Col>
...
//                           onChange={(event) => this.getAmphur(event)}
//                         >
//                           <option value="">Select</option>
//                           {srt_province}
//                         </Input>
...
//                           data-live-search="true"
//                           class="form-control select"
//                           onChange={(event) => this.getDistrict(event)}
//                         >
//                           <option value="">Select</option>
//                           {this.state.amphur}
//                         </Input>
...
//                           data-live-search="true"
//                           class="form-control select"
//                           onChange={(event) => this.getZipCode(event)}
//                         >
//                           <option value="">Select</option>
