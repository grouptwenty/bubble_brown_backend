...
//             washing_machine_code_max: 'WS' + max_code.data.washing_machine_code_max
//         })
//         // document.getElementById('entrepreneur_code').value = this.props.entrepreneur_code
//         // document.getElementById('laundry_code').value = this.props.laundry_code
//     }
...
//         arr['addby'] = this.props.admin_code
//         arr['washing_machine_img'] = ""
//         arr['laundry_code'] = this.props.laundry.laundry_code
...
//                             <Modal.Title>เพิ่มเครื่องซักผ้า</Modal.Title>
//                         </Modal.Header>
//                         <Modal.Body>
...
//                                                                 <Input type="text" id="washing_machine_code" name="washing_machine_code" class="form-control" value={this.state.washing_machine_code_max} readOnly />
...
//                                             <Input type="select" id="laundry_code" name="laundry_code" class="form-control" disabled>
...
//                     <Button
//                         type="button"
//                         class="btn-lg float-right boottom-header"
//                         color="success"
