...
//         }
//         // arr['addby'] = this.props.user.user_code //เรียกใช้ addby ที่เป็นคนเพิ่มข้อมูล
//         // console.log(arr)
...
//             //     arr['user_image'] = await this.fileUpload(this.state.selectedFile, 'user', form.elements['user_code'].value + "_" + toDay);
//             // }
...
//                                                         {imagePreview}
//                                                     </Col>
//                                                     <input type="file" class="form-control" multiple onChange={this.onChangeHandler} name="user_image" />
//                                                 </div>
//                                             </FormGroup>
...
//                                                 <Input type="hidden" id="user_image" name="user_image" class="form-control" readOnly ></Input>
